...
class PdfAddActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //handle cick, start uploading pdf/book
    ...
    private fun uploadPdfToStorage() {
        ...
        storageReference.putFile(pdfUri!!)
            ...
            .addOnFailureListener{ e->
                ...
                Toast.makeText(this, "Failed to upload to Storage due to ${e.message}", Toast.LENGTH_SHORT).show()
            }
    }
    ...
    private fun uploadPdfInfoToDb(uploadedPdfUrl: String, timestamp: Long) {
        ...
        //db reference Db> books> bookId > (Boook Info)
    ...
    private fun loadPdfCategories() {
        ...
        //db refrence to load categories pdf> Categories
