...
class MyApplication: Application() {
    ...
    companion object{
        ...
        fun deleteBook(context: Context, bookId: String, bookUrl: String, bookTitle:String){
            ...
            //2, bookId, to delete book form db
                ...
                .addOnSuccessListener {
                    ...
                    ref.child(bookId)
                        ...
                        .addOnSuccessListener {
                            ...
                            Log.d(TAG, "deleteBook: Delete fom db too...")
                        ...
                        .addOnFailureListener { e->
                            ...
                            Toast.makeText(context, "deleteBook: Failed to delete from database due to ${e.message}",Toast.LENGTH_SHORT).show()
